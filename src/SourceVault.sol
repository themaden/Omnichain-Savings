...
contract SourceVault is ERC4626, Ownable {
    ...
    function bridgeToStrategy(
        ...
        // 3. Send!
        IRouterClient(i_router).ccipSend{value: 0}(
            // Note: In reality, you need to send value (ETH) for fees
    ...
    function getFee(
        ...
        return
            IRouterClient(i_router).getFee(_destinationChainSelector, message);
    }
}
